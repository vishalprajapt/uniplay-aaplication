...
function Address() {
  ...
  const [localstoragedata, setlocalstoragedata] = useState(() => {
    return JSON.parse(localStorage.getItem("arrayID")) || [];
  });
  ...
  const startPolling = (orderId) => {
    pollingInterval = setInterval(async () => {
      ...
      if (res.data.paymentKey === "PAYMENT_SUCCESS") {
        ...
        setTimeout(() => {
          //     setShowPopup(true);
          //  setAlertType("success")
          toast.success('Successfully purchse video');
        ...
        //   const dataPrivious=[...pre, singalitem.id]
        //   localStorage.setItem("arrayID", JSON.stringify(dataPrivious));
        //   return dataPrivious;
        // })
        // navigate("/")
      }

      if (res.data.paymentKey === "PAYMENT_FAILED") {
        clearInterval(pollingInterval);
